...
class Valid_board{
  public:
    ...
    Valid_board(int,int,string,string,SDL_Renderer*);	// the non-default constructor that will acutally be used
    ...
    void add_attack_spots(int);				// puts 2s around the array where a player with int attack_range can attack
  private:
